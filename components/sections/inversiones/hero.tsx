...
export default function InversionesHero() {
  const { t } = useTranslation()
  return (
    <section className="relative min-h-[450px] py-20 overflow-hidden w-full bg-gradient-to-br from-[#1d3969] to-[#2563eb]">
      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        <div className="text-center animate-[fadeInDown_0.8s_ease-out]">
          ...
          <p className="text-xl md:text-2xl text-white/95 leading-relaxed max-w-4xl mx-auto mb-4">
            {t('investments.hero.subtitle')}
          </p>
